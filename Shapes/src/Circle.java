...
public class Circle extends ClosedShape {
    ...
    /**
	  * Get the width of the current component(overrode so it returns the diamater value(actual width))
	  *
	  * @return the diameter of the circle	  
	  */
 	public int getWidth() {
    ...
    public void draw (GraphicsContext g) {
    	...
    	g.setStroke( colour );
    	if (isFilled) {
		//circle is an oval with height and width both set to diameter
